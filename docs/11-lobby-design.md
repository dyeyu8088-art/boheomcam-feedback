...
| 层 | 内容 | 目的 |
| --- | --- | --- |
| **L1 远景**（SVG 1920×1080 slice） | `bdSky` 三段渐变 → `bdWeave` 朝鲜族菱格暗纹（不透明度 0.045–0.055）→ `bdCore` 中央 radial 光源 → 冷月（1712,150）→ 星尘 → 长白山远/近山脊 → 主峰雪线 → 松林剪影 | 「四周暗、中央微亮」，把注意力压到游戏卡区 |
...
- 标题：旗舰 32px/800（2K 41px），其余 23px/800（2K 29px）；金属渐变文字 + `text-shadow`
...
| 是否具有延边娱乐自己的品牌？ | 是。长白山 / 雪 / 松 / 朝鲜族纹样贯穿背景、纹章、麻将场景；字标 + 双环山峰标志 |
